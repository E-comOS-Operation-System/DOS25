...
echo ""
echo "Disk layout:"
echo "  Sector 1: Boot menu"
echo "  Sector 2: bootsect.s"
echo "  Sector 3-22: Kernel (put your kernel here)"
echo "  Sector 50-79: Rescue boot"
echo "  Sector 80-99: Rescue kernel"
echo ""
echo "To add kernel: dd if=kernel.bin of=build/dos25.img bs=512 seek=2 conv=notrunc"
